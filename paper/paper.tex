...
buffer_size = <int n>
[precision]
interval_gratularity = <float f>
data_gratularity = <float f>
[frequency]
...
CPU. Bij de Zigduino is dit 16MHz.
 ...
 \subparagraph{Kost van de reductie: frequentie schrijven naar RAM.}
...
tijdsinformatie op een gelijkaardige manier moet worden afgeleid
...
Schrijven naar RAM is haast gratis en is daarom een zeer goede reductiestrategie. De resultaten zijn te zien op \ref{fig:energieverbruik_ram}.
