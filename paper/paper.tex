...
% De tool gebruikt volgende formule voor de energie berekening: 

%$ 8.144 \cdot 10^{-5} mJ/Byte \cdot sensor\_ data\_ size \cdot sensor\_ data\_ frequency +  0.0037A \cdot reduction\_  cpu\_ time \cdot 6V + 0.04A \cdot ( $

\todo[inline]{Ben er mee gestopt, de formule is te lang om hier te zetten, we zouden die dan ook nog moeten uitleggen en vanwaar alles komt, ik zou dat niet doen, zeker omdat we niet zeker zijn dat dit helemaal juist is. Ik zou een soort verwijzing naar de tool zetten?}
\begin{enumerate}
