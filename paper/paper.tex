...
vacu\üm zijn gedaan: de kost van het draaien van het OS, van het op laten staan
...
\subsection{Volledige netwerktopologie\ën}

Conclusies uitbreiden naar volledige netwereken (past mooi binnen pyramidestructuur) gebruik maken van aantal hops (indien bvb de node z’n geheugen vol is, of door het beschouwen van de kost van de transmissie over meerdere nodes). Bijvoorbeeld: metric zegt nee voor een enkele node, maar de kost van het reduceren van de output zorgt ervoor dat de transmissiekost over het netwerk als geheel in functie van het aantal hops groter is dan de kost van het reduceren van de output. Maak gebruik van zowel de cost van verzenden als ontvangen.
