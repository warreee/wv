...
Voor het meten van het energieverbruik gedurende een bepaalde periode maken we
gebruik van het volgende circuit:

<<<<<<< HEAD
\begin{figure}[H]
  \centering
  \includegraphics[0.9\columnwidth,keepaspectratio=true]{meetopstelling}
...
\label{fig:meetopstelling}
>>>>>>> b5c9b970f7e62c24c9649f9adee302782056e613
\end{figure}
