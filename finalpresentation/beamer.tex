...
\[
    h(x)= 
\begin{cases}
  1, & \text{als } tr(x) - cost(red(x)) - cost(tr(red(x)))  \\
  0, & \text{otherwise}
\end{cases}
\]
...
\begin{frame}{Sense and send}
  ...
  \begin{exampleblock}{}
    \textbf{Totaalkost:} 1639.6992mJ per tijdseenheid
  \end{exampleblock}
...
\begin{frame}{Filter}
  ...
  \begin{exampleblock}{}
    \textbf{Totaalkost:} 819.849762875015mJ per tijdseenheid
  \end{exampleblock}
\end{frame}
...
\begin{frame}{Aggregatie}
  ...
  \begin{exampleblock}{}
    \textbf{Totaalkost:} 27.33809250090574mJ per tijdseenheid
  \end{exampleblock}
\end{frame}
...
\begin{frame}{Gemiddelde}
  ...
  \begin{exampleblock}{}
    \textbf{Totaalkost:} 38.15633250090575mJ per tijdseenheid
  \end{exampleblock}
