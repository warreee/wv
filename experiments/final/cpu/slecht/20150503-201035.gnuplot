...
# 20150503-201035.gnuplot [generated by /home/warreee/attenload/adsparse-wave.pl]
...
tdiv = 0.01          # T/DIV (50e-9)
toffs = 0        # time offset (scope) (200e-9)
vdiv1 = 1        # V/DIV CH1 (500e-3)
vdiv2 = 2         # V/DIV CH2 (50e-3)
voffs1 = -0.4         # volt offset CH1 (-1.5)
voffs2 = -0.96       # volt offset CH2 (100e-3)
sampintp  = 2e-05    # (500e-12)
sampintf  = 1/sampintp
sratacqf  = 50000      # (250e6)
sratacqp  = 1/sratacqf
...
fts=2e-05         # final timestep (sampling period)
