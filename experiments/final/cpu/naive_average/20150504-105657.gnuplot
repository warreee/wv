...
# 20150504-105657.gnuplot [generated by /home/warreee/attenload/adsparse-wave.pl]
...
tdiv = 0.001          # T/DIV (50e-9)
toffs = 0.00540000009536743        # time offset (scope) (200e-9)
vdiv1 = 1        # V/DIV CH1 (500e-3)
vdiv2 = 1         # V/DIV CH2 (50e-3)
voffs1 = -0.4         # volt offset CH1 (-1.5)
voffs2 = -0.48       # volt offset CH2 (100e-3)
sampintp  = 2.0000002e-06    # (500e-12)
sampintf  = 1/sampintp
sratacqf  = 500000      # (250e6)
sratacqp  = 1/sratacqf
...
fts=2e-06         # final timestep (sampling period)
