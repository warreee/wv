...
doel: deploy and forget
\end{block}%
\begin{block}{adaptief}
doel: makkelijke aanpasbare topologie
\end{block}
...
\begin{frame}[label=sec-3-1]{Waarom is energieverbruik belangrijk?}
  \begin{itemize}
  \item belangrijk aspect van WSN-design
  \end{itemize}
\end{frame}
...
\item flash en CPU iets minder, maar:
  \begin{itemize}
  \item{lage kloksnelheid $\Rightarrow$ slechte concurrency, slechte
performantie in het algemeen}
