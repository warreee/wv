...
\begin{frame}[label=sec-1-2]{Waarom WSNs?}
\begin{itemize}
\item dicht bij het te observeren fenomeen
\item makkelijk te plaatsen: simpele topologie
\item lagere kost dan traditionele systemen
\item flexibel inzetbaar
\end{itemize}
\end{frame}

\begin{frame}[label=sec-1-3]{Toepassingen}
\begin{itemize}
\item militaire context
\item biologie \& ecologie
\item geneeskunde
\item domotica
\item \ldots{}
\end{itemize}
...
\begin{frame}[label=sec-1-4]{Het Great Duck Island-experiment}
\begin{itemize}
