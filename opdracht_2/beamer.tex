...
\vfill
\begin{tabular}{c c c}
\includegraphics[width=0.25\textwidth,keepaspectration=true]{cpu} & \includegraphics[width=0.25\textwidth,keepaspectration=true]{radio} & 
\includegraphics[width=0.25\textwidth,keepaspectration=true]{storage} \\
COMPUTE & TRANSMIT & STORE
\end{tabular}
\vfill
\item transmitting kost veel energie
\end{itemize}
\end{frame}
