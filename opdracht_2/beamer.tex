...
\begin{frame}[label=sec-3-2]{Hoe meten we het?}
  ...
  \note{
    \begin{itemize}
    \item een oscilloscoop meet voltage t.o.v. tijd
    \item kan ook veel afleiden uit zijn metingen
    \end{itemize}
  }
\end{frame}
...
\begin{frame}[label=sec-3-3]{Meetopstelling}
  ...
  \note{
    \begin{itemize}
    \item we willen het stroomverbruik van bepaalde methodes plotten
    \item pinnetje flippen met behulp van software trigger
    \end{itemize}
  }
\end{frame}
