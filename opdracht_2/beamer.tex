...
\begin{itemize}
\item consume extremely low power,
\item operate in high volumetric densities,
\item have low production cost and be dispensable,
\item be autonomous and operate unattended,
\item be adaptive to the environment.
\end{itemize}
\end{frame}
...
\hiddencell{2}{STORE} & \hiddencell{3}{COMPUTE} & \hiddencell{4}{TRANSMIT}
\end{tabular}
\vfill
\end{itemize}
\end{frame}
